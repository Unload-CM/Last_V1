...
export default function AdminLogin() {
  ...
  const { error: errorParam, callbackUrl: callbackUrlParam } = router.query;
  ...
  useEffect(() => {
    ...
    // URL 파라미터 확인
    console.log('현재 callbackUrl:', callbackUrlParam);
  }, [t, callbackUrlParam]);
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      let callbackUrl = callbackUrlParam as string || '/';
      
      // 이미지 경로를 포함하는 callbackUrl 필터링
      if (callbackUrl && (callbackUrl.includes('/images/') || callbackUrl.includes('.png') || callbackUrl.includes('.jpg'))) {
